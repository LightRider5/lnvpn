...
const RuntimeSelector = (props) => {
  ...
  return (
    <div>
    <ToggleButtonGroup type="radio" name="options" id="runtimeselector" defaultValue={0.5} >
      {/* <ToggleButton id="tbg-radio-1" value={0.1} onChange={props.onClick} title="1 hour">
        1 <br></br> hour
      </ToggleButton> */}
