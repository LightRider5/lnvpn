      ...
      >
        ...
        <Modal.Body>
          ...
          {props.isConfigModal ? (
            <div>
              <p>
                WireGuard VPN config, scan via the{" "}
                <a
                  href="https://www.wireguard.com/install/"
                  target="_blank"
                  rel="noreferrer"
                >
                  WireGuard App on your smartphone
                </a>
                , download the config file for{" "}
                <a
                  href="https://www.wireguard.com/install/"
                  target="_blank"
                  rel="noreferrer"
                ...
                or send it to yourself via Email to use it later on another
                device.
              </p>
        ...
        <Modal.Footer>
          ...
          {props.isConfigModal ? (
            <Button variant="success" onClick={props.download}>
              Download as File
            </Button>
          ) : (
            <Button
